#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════
# Packbox i18n — Traducciones compartidas
# Sourced by: packbox-installer-v0.1.0.sh + packbox-packager-v0.1.0.sh
# ═══════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════
# install_lang_files — escribe los 9 archivos
# ═══════════════════════════════════════════════════════════════
install_lang_files() {
